...
export function ProfileDashboard({ open, onClose }: ProfileDashboardProps) {
  ...
  const closeDisabled = saving || uploadingAvatar
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="mt-4 flex flex-wrap gap-2">
                              ...
                              <button onClick={() => fileInputRef.current?.click()} disabled={closeDisabled} className="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-medium text-slate-700 transition hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-50">
                                <Camera className="h-4 w-4" />
                                {uploadingAvatar ? 'Updating...' : 'Change Photo'}
                              </button>
                              <button onClick={removeAvatar} disabled={closeDisabled} className="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-medium text-slate-700 transition hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-50">
